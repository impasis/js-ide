...
js_syntax_vscode = [
    [r"\b(for|in|while|do|break|return|continue|switch|case|default|if|else|throw|try|catch|finally|yield|await|async|this|of|static|export|import|debugger|extends|super|var|let|const|with|function|class|true|false|null|NaN|Infinity|undefined)\b", vscode_colors["keywords"]],
